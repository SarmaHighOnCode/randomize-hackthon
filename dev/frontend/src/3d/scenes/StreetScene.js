...
export class StreetScene {
  ...
  setup(ctx) {
    ...
    for (let wx = -10.4; wx <= 10.4; wx += 2.6) {
      ...
      for (let wy = 1.9; wy < 44; wy += 3.8) {
        ...
        if (isLit) {
          ...
          winMat.emissiveIntensity = 5.0; // Boosted
        } else {
    ...
    // Make billboard glow
    const l1bMat = l1Billboard.material;
    l1bMat.emissive = new THREE.Color(0x330000);
    l1bMat.emissiveIntensity = 10.0; // Boosted
    ...
    const neonMat = neonStripe.material;
    neonMat.emissive = new THREE.Color(0x00bbff);
    neonMat.emissiveIntensity = 2.0; // Normalized from 0.5 but boosted for 1.4x shader
    ...
    const r1bMat = r1Billboard.material;
    r1bMat.emissive = new THREE.Color(0xaa4400);
    r1bMat.emissiveIntensity = 8.0; // Boosted
